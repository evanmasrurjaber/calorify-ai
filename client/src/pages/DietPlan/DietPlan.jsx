      ...
      <div className="max-w-7xl mx-auto space-y-8 animate-fade-in-up">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 bg-white/80 backdrop-blur-md border border-[#e1e2e8] rounded-3xl p-6 sm:p-8 shadow-xs">
          ...
          <button
            ...
            disabled={generating}
            className="w-full md:w-auto self-start md:self-auto bg-gradient-to-r from-[#10B981] to-[#006c49] hover:from-[#059669] hover:to-[#004d34] text-white font-bold py-3.5 px-6 rounded-2xl transition-all shadow-md shadow-[#10B981]/20 flex items-center justify-center gap-2 group hover:scale-[1.02] disabled:opacity-60 active:scale-95 text-sm"
          >
            <RefreshCw
              size={18}
            ...
            />
            <span>{generating && prefModal.scope === 'week' ? 'Synthesizing Plan...' : 'Regenerate Entire Week'}</span>
          </button>
        </div>
        ...
        {/* ── CUISINE & PREFERENCES POPUP MODAL ── */}
        {prefModal.isOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in-up">
            <div className="bg-white border border-[#e1e2e8] w-full max-w-2xl rounded-3xl overflow-hidden shadow-2xl relative flex flex-col max-h-[92vh]">
              {/* Header */}
              <div className="p-6 bg-[#fafbff] border-b border-[#e1e2e8] flex justify-between items-start">
                ...
                <button
                  ...
                  disabled={generating}
                  className="text-[#565e74] hover:text-[#0F172A] p-2 rounded-xl hover:bg-gray-100 transition"
                >
                  <X size={20} />
                </button>
              </div>
              ...
              <div className="p-6 overflow-y-auto space-y-6 flex-1 bg-white">
                      ...
                      return (
                        ...
                        >
                          <div className={`w-5 h-5 rounded-lg border flex items-center justify-center shrink-0 mt-0.5 transition-colors ${
                            isSelected ? 'bg-[#10B981] border-[#10B981] text-white' : 'border-gray-300 bg-white'
                          }`}>
                ...
                <div className="space-y-3">
                  ...
                  <div className="pt-1">
                    <input
                      ...
                      onChange={(e) =>
                        setPrefModal((prev) => ({ ...prev, customDietPreference: e.target.value }))
                      }
                ...
                {/* 3. CUSTOM NOTES / REQUESTS SECTION (AS REQUESTED: KEPT AS IS) */}
              ...
              <div className="p-4 bg-[#fafbff] border-t border-[#e1e2e8] flex justify-end gap-3">
                <button
                  onClick={() => setPrefModal((prev) => ({ ...prev, isOpen: false }))}
                  disabled={generating}
                  className="px-5 py-2.5 text-xs font-bold text-[#565e74] hover:text-[#0F172A] hover:bg-gray-100 rounded-xl transition"
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={generating}
                  className="px-6 py-2.5 bg-gradient-to-r from-[#10B981] to-[#006c49] hover:from-[#059669] hover:to-[#004d34] text-white text-xs font-bold rounded-xl transition shadow-md shadow-[#10B981]/25 flex items-center gap-2 disabled:opacity-60 active:scale-95"
                >
                  {generating ? (
                    <>
        ...
        {selectedMeal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fade-in-up">
            <div className="bg-white border border-[#e1e2e8] w-full max-w-2xl rounded-3xl overflow-hidden shadow-2xl relative flex flex-col max-h-[90vh]">
              {/* Modal Header */}
              <div className="p-6 bg-[#fafbff] border-b border-[#e1e2e8] flex justify-between items-start">
                <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="text-[#565e74] hover:text-[#0F172A] bg-white p-2 rounded-xl border border-[#e1e2e8] hover:bg-gray-100 transition"
                  >
                    <X size={20} />
                  </button>
                </div>
                ...
                {!recipeData && !recipeLoading && (
                  <div className="text-center py-8 space-y-4">
                    ...
                    <button
                      ...
                      className="bg-gradient-to-r from-orange-500 to-rose-500 hover:from-orange-600 hover:to-rose-600 text-white font-bold px-8 py-3.5 rounded-xl transition shadow-md shadow-orange-500/20 active:scale-95 text-xs inline-flex items-center gap-2"
                    >
                      <Sparkles size={16} />
